        ...
        <div class="window__body">
            <div class="metrics-cards">
                <div class="metric" v-for="metric in metrics">
                    <did class="metric__marker" :style="{ backgroundColor: metric.indicator }"></did>
                    <p class="metric__title">{{ metric.title }}</p>
                    <h2 class="metric__value">{{ metric.value }} {{ metric.measure }}</h2>
            ...
            return{
                ...
                metrics: [
                    ...
                    },
                    {
                        ...
                        value: '1000',
                        measure: 'ms',
                        description: 'Время преобразования доменного имени в IP-адрес через DNS'
                    },
                ],
            }
        },
